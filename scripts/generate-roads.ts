...
// Fetch the Dubai-focused area used by the optional animated road overlay. The
// Mapbox basemap remains the source for roads in the wider regional view, so
// this lightweight overlay does not need to duplicate the full UAE road graph.
