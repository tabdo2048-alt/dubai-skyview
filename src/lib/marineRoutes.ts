...
export const VESSEL_FLEET: VesselSpec[] = [
  { name: "gulf-ship", route: GULF_LANE, count: 1, speedMps: 7, sizeScale: 3, intensity: 1, build: buildShip },
  { name: "gulf-boats", route: GULF_LANE, count: 2, speedMps: 9, sizeScale: 6, intensity: 1, build: buildBoat },
  { name: "marina-yacht", route: MARINA_LANE, count: 1, speedMps: 4, sizeScale: 4, intensity: 0.35, build: buildYacht },
  { name: "marina-boats", route: MARINA_LANE, count: 2, speedMps: 6, sizeScale: 6, intensity: 0.35, build: buildBoat },
  { name: "palm-yacht", route: PALM_LAGOON_LANE, count: 1, speedMps: 4, sizeScale: 4, intensity: 0.25, build: buildYacht },
  { name: "palm-boat", route: PALM_LAGOON_LANE, count: 1, speedMps: 6, sizeScale: 6, intensity: 0.25, build: buildBoat },
  { name: "creek-boats", route: CREEK_LANE, count: 2, speedMps: 5, sizeScale: 6, intensity: 0.3, build: buildBoat },
  { name: "canal-yacht", route: CANAL_LANE, count: 1, speedMps: 3, sizeScale: 4, intensity: 0.22, build: buildYacht },
];
